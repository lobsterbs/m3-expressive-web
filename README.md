...
open an issue.
- [abhixv/m3-expressive-design-skill](https://github.com/abhixv/m3-expressive-design-skill) — M3E agent skill with a large reference-image set; scouted for the skills ecosystem map
- [c-orter/material_3_expressive](https://github.com/c-orter/material_3_expressive) — faithful Flutter M3E port; its live demo informed our wavy-progress TODO(spec) markers
- The [Material 3 Expressive announcement post](https://m3.material.io/blog/building-with-m3-expressive) for the 35-shape and emphasized-typography framing
